...
const sliderClass =
  'w-full accent-blue-500 [&::-webkit-slider-thumb]:cursor-pointer';
    ...
    <div className="pointer-events-auto min-w-[240px] rounded-lg border border-blue-500/30 bg-gray-950/85 p-4 text-blue-100 backdrop-blur">
      ...
      <div className="mb-3">
        ...
        <input
          ...
          onChange={(e) => { setTiltAngles(parseFloat(e.target.value), tiltBeta); }}
          disabled={!rcmPoint}
        />
      </div>
      ...
      <div className="mb-3">
        ...
        <input
          ...
          value={tiltBeta}
          className={sliderClass}
          onChange={(e) => { setTiltAngles(tiltAlpha, parseFloat(e.target.value)); }}
          disabled={!rcmPoint}
        />
      </div>
      ...
      <div className="mb-3">
        ...
        <div className="flex flex-wrap gap-2">
          {[
            ...
            <button
              key={label}
              onClick={() => { setTiltAngles(a as number, b as number); }}
              disabled={!rcmPoint}
      ...
      <div className="mt-2 flex gap-2">
        <button
          ...
          className="pointer-events-auto rounded border border-green-500/40 bg-green-500/20 px-3 py-1.5 text-xs text-green-400 transition-all duration-150 hover:bg-green-500/30 hover:border-green-500/60 disabled:opacity-40 disabled:cursor-not-allowed"
        >
        ...
        <button
          onClick={reset}
          className="pointer-events-auto rounded border border-red-500/30 bg-red-500/20 px-3 py-1.5 text-xs text-red-400 transition-all duration-150 hover:bg-red-500/30 hover:border-red-500/50"
        >
          Reset
        </button>
      </div>
      ...
      <div className="mt-3 border-t border-blue-500/15 pt-2 text-[11px] text-blue-300/50">
        ...
        <p>
          <kbd className="inline-block rounded border border-blue-500/30 bg-blue-500/15 px-1 py-0.5 font-mono text-[10px] text-blue-100">R</kbd> Reset &nbsp;{' '}
          <kbd className="inline-block rounded border border-blue-500/30 bg-blue-500/15 px-1 py-0.5 font-mono text-[10px] text-blue-100">C</kbd> Clear trails
        </p>
        <p>
          <kbd className="inline-block rounded border border-blue-500/30 bg-blue-500/15 px-1 py-0.5 font-mono text-[10px] text-blue-100">↑↓</kbd> Insert/Withdraw &nbsp;{' '}
          <kbd className="inline-block rounded border border-blue-500/30 bg-blue-500/15 px-1 py-0.5 font-mono text-[10px] text-blue-100">←→</kbd> Rotate azimuth
        </p>
        <p>
          <kbd className="inline-block rounded border border-blue-500/30 bg-blue-500/15 px-1 py-0.5 font-mono text-[10px] text-blue-100">1-4</kbd> Preset tilt angles (0/15/30/45deg)
        </p>
        <p className="mt-1 mb-1 text-xs font-semibold text-blue-400">Mouse</p>
        <p>
          <kbd className="inline-block rounded border border-blue-500/30 bg-blue-500/15 px-1 py-0.5 font-mono text-[10px] text-blue-100">Left Click</kbd> Place RCM &nbsp;{' '}
          <kbd className="inline-block rounded border border-blue-500/30 bg-blue-500/15 px-1 py-0.5 font-mono text-[10px] text-blue-100">Left Drag</kbd> Tilt needle &nbsp;{' '}
          <kbd className="inline-block rounded border border-blue-500/30 bg-blue-500/15 px-1 py-0.5 font-mono text-[10px] text-blue-100">Scroll</kbd> Insert/Withdraw
        </p>
        <p>
          <kbd className="inline-block rounded border border-blue-500/30 bg-blue-500/15 px-1 py-0.5 font-mono text-[10px] text-blue-100">Right Drag</kbd> /{' '}
          <kbd className="inline-block rounded border border-blue-500/30 bg-blue-500/15 px-1 py-0.5 font-mono text-[10px] text-blue-100">Middle Drag</kbd> Orbit camera
        </p>
      </div>
    </div>
  );
